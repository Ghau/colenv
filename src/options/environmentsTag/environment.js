...
customElements.define('environments-container', class extends HTMLElement {
    ...
    environmentMove(e) {
        ...
        const mouseUp = () => {
            environment.style.removeProperty('zIndex');
...
customElements.define('environment-container', class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        inputColor.addEventListener('change', () => this.dispatchEvent(new CustomEvent('change')));
...
customElements.define('url-container', class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.urlInput.placeholder = this.getUrlPlaceHolder(simplified);
    ...
    load(value) {
        ...
        typeInput.checked = value.simplified !== undefined && value.simplified ? false : true;
